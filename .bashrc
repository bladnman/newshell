...
alias _ls=ls # holding on to original ls
...
if command -v eza &>/dev/null; then
    ...
    alias els='eza --icons=auto --color=auto --group-directories-first'
    alias tree='eza -T --icons=auto --color=auto --group-directories-first'
else
    echo "For a better ls experience, try installing 'eza': https://github.com/eza-community/eza"
